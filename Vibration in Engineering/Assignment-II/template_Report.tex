...
\end{eqnarray*}
Mode shape that corresponds to an arbitrary $\lambda$ is found from ~\cref{eq:spacesolution} using the relations \crefrange{eq:acrel}{eq:barel}. The expression for the mode shapes for a specific $\lambda$ is found as
\begin{eqnarray*}
